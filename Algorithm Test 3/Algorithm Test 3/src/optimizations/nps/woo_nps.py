"""
Wave Optics Optimizer with DE-NPS Strategies
Integrates DE-NPS strategies into WOO algorithm.
"""
...
class WOO_NPS(WaveOpticsOptimizer):
    ...
    def optimize(self):
        ...
        for t in range(1, self.max_generations + 1):
            ...
            tau2_thresh = tau2_thresh * adaptive_param  # Adjust threshold
            ...
            for i in range(self.pop_size):
                ...
                if np.random.rand() < 0.3:
                    X_new = self.denps.logarithmic_spiral_perturbation(X_i, X_new)
