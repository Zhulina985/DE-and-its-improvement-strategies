"""
Flood Algorithm with DE-NPS Strategies
Integrates DE-NPS strategies into Flood Algorithm.
"""
...
class FLOOD_NPS(FloodAlgorithm):
        ...
        for t in range(1, self.max_generations + 1):
            ...
            for i in range(self.pop_size):
                ...
                if np.random.rand() < 0.3:
                    new_pos = self.denps.logarithmic_spiral_perturbation(population[i], new_pos)
