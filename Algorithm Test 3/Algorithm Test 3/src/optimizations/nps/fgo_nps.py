"""
Fungal Growth Optimizer with DE-NPS Strategies
Integrates DE-NPS strategies into FGO algorithm.
"""
...
class FGO_NPS(FungalGrowthOptimizer):
    ...
    def optimize(self):
        ...
        for t in range(1, self.max_generations + 1):
            ...
            # Use adaptive parameter from DE-NPS to influence exploration threshold
            ...
            for i in range(self.pop_size):
                ...
                if np.random.rand() < 0.3:
                    S_new = self.denps.logarithmic_spiral_perturbation(S_i, S_new)
